...
public class main {
    public static void main(String[] args){
        ...
        System.out.println("demotest run...");
        System.out.println("===== 构建一个GPS模型开始 =====");
        Pbtest.gps_data.Builder gps_builder = Pbtest.gps_data.newBuilder();
        ...
        Pbtest.gps_data gps_data = gps_builder.build();
        ...
        Pbtest.gps_data gd = null;
        try {
            gd = Pbtest.gps_data.parseFrom(gps_data.toByteArray());
